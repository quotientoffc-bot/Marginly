...
# We want two separate scroll progresses or we can just map one progress over the full sequence.
# Let's change the height to 300vh.
# start end -> end end
# [0, 0.33] -> scrolling into view (scale 0.7 to 1.0)
# [0.33, 0.66] -> pinned at top (opacity 0 to 1)
# [0.66, 1] -> pinned at top (text settled)

new_component = '''import { useRef } from "react";
